...
public class App {
    public static void main(String[] args) throws Exception {
        ...
        for (int i = 0; i < 3; i++) {
            ...
            if (doubleRating > 7.5) {
                texto = "TOPZERA";
                imagem = new FileInputStream(new File("sobreposicao/topzera.jpeg"));
            } else {
                texto = "MEDIANO";
                imagem = new FileInputStream(new File("sobreposicao/mediano.jpg"));
            }

            gerafiguras.gerar(inputStream, nomeArquivo, texto, imagem);
